...
public class MultipleSelectionActivity extends AppCompatActivity {
    ...
    private android.support.v7.widget.AppCompatButton btnGetClear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.btnGetClear = (AppCompatButton) findViewById(R.id.btnGetClear);
            ...
            public void onClick(View view) {
                ...
                if (adapter.getSelected().size() > 0) {
                   ...
                   // showToast(stringBuilder.toString().trim());
                    Intent intent2=new Intent(MultipleSelectionActivity.this, FreeAsstes.class);
        ...
        btnGetClear.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AppData.selectcatList.clear();
                createList();
